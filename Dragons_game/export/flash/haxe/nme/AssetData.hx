...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/bulletsplayer.png", nme.NME_assets_bulletsplayer_png);
			type.set ("assets/bulletsplayer.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/dragonsheet.png", nme.NME_assets_dragonsheet_png);
			type.set ("assets/dragonsheet.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_bulletsplayer_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
...
class NME_assets_dragonsheet_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
