...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/player2.png", nme.NME_assets_player2_png);
			type.set ("assets/player2.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_player2_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
