...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("Laser", nme.NME_assets_laser_wav);
			type.set ("Laser", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Explosion", nme.NME_assets_explosion_wav);
			...
			className.set ("assets/enemybullet.png", nme.NME_assets_enemybullet_png);
			type.set ("assets/enemybullet.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/grasping.ttf", nme.NME_assets_grasping_ttf);
			type.set ("assets/grasping.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			...
			className.set ("assets/horrendo.ttf", nme.NME_assets_horrendo_ttf);
			type.set ("assets/horrendo.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			className.set ("assets/intro.png", nme.NME_assets_intro_png);
			type.set ("assets/intro.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_laser_wav extends flash.media.Sound { }
class NME_assets_explosion_wav extends flash.media.Sound { }
...
class NME_assets_enemybullet_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_grasping_ttf extends flash.text.Font { }
class NME_assets_haxeflixel_svg extends flash.utils.ByteArray { }
class NME_assets_horrendo_ttf extends flash.text.Font { }
class NME_assets_intro_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
